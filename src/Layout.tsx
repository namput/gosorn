...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  <Helmet>
        ...
        <link rel="canonical" href="https://guson.co" />
        ...
        <meta property="og:image" content="https://guson.co/images/og-image.jpg" />
        <meta property="og:url" content="https://guson.co" />
        ...
        <meta name="twitter:image" content="https://guson.co/images/twitter-image.jpg" />
