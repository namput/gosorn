 ...
 {/* Sections */}
    <div className="space-y-10 text-base leading-relaxed">
      ...
      <section id="contact">
        ...
        <p>
          หากต้องการใช้สิทธิของท่าน โปรดติดต่อที่: <a className="text-blue-600 underline" href="mailto:support@guson.co">support@guson.co</a> โดยระบุข้อมูลยืนยันตัวตน เช่น อีเมลที่ใช้สมัคร หรือ ID ผู้ใช้งาน
        </p>
