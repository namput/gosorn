...
const StartSearchTutor = () => {
  ...
  const handleNext = () => {
    if (selectedSubject.trim() !== "") {
      navigate("/student/search-tutor/details", {
  ...
  return (
    <>
      <SEO
        title="ค้นหาติวเตอร์สอนพิเศษ | หาครูที่ใช่ได้ง่ายบน Guson"
        description="ค้นหาติวเตอร์สอนพิเศษที่เหมาะกับคุณ เลือกจากรีวิวจริงและประสบการณ์ พร้อมตัวกรองค้นหาที่ใช้งานง่าย"
        path="/search-tutor/start"
      />{" "}
      <div className="min-h-screen p-8 bg-gradient-to-b from-purple-50 to-white space-y-12">
        ...
        <section className="text-center space-y-3">
          ...
          <p className="text-gray-500 text-lg">
            เลือกสิ่งที่คุณสนใจ หรือพิมพ์เองได้เลย
          </p>
        </section>
        ...
        <div className="text-center text-gray-400">
          หรือเลือกจากหมวดหมู่ที่เราจัดไว้
        </div>
