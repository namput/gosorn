...
const Forum = () => {
  ...
  return (
    <>
      <SEO
        title="ฟอรัมติวเตอร์ & นักเรียน | สนทนาและแบ่งปันประสบการณ์"
        description="เข้าร่วมชุมชนติวเตอร์และนักเรียน พูดคุยปัญหา เทคนิคการสอน และการค้นหาติวเตอร์"
        path="/forum"
      />
        ...
        {!loading && !error && threads.length > 0 ? (
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-2 text-gray-500 text-sm">
                      <span className="flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-600 rounded-full font-semibold text-xs">
                        ...
                        {thread.category || "ทั่วไป"}
                      </span>
                      <span className="flex items-center gap-1 text-sm text-gray-600">
                        <FaCommentDots className="text-gray-400" />{" "}
                        {thread.comment_count || 0} ตอบกลับ
                      </span>
                    </div>
                  </div>
          ...
          !error && (
            <div className="text-center text-gray-500 text-lg mt-10">
              ...
              />
              ❌ ยังไม่มีการตั้งกระทู้เลย! <br />{" "}
              มาเป็นคนแรกที่ตั้งกระทู้กันเถอะ 🎉
            </div>
          )
        )}
      </div>
